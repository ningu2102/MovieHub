...
import com.nrkbytes.moviehub.adapters.MoviesAdapter
import com.nrkbytes.moviehub.adapters.VideosController
import com.nrkbytes.moviehub.data.MovieDetailsViewModel
import com.nrkbytes.moviehub.data_models.Movie
import com.nrkbytes.moviehub.data_models.Video
import com.nrkbytes.moviehub.databinding.ActivityMovieDetailsBinding
import com.nrkbytes.moviehub.extensions.*
import com.nrkbytes.moviehub.network.models.MovieDetailsResponse
...
class MovieDetailsActivity : BaseActivity() {
    ...
    private fun playVideo() {
        ...
        val firstVideoKey = firstVideo?.key
        val youtubeUrl = "https://www.youtube.com/watch?v=$firstVideoKey"
    ...
    private fun updateDetails(details: MovieDetailsResponse) {
        ...
        // Videos
        videos.addAll(details.videos.results)
